...
// consiga enviar para o robô Curiosity o que você deseja fazer, uma vez obtida com sucesso
//  a temperatura em Marte. Logo, adicione na função sendMarsTemperature uma callback que 
...
const sendMarsTemperature = (callback, temp) => {
  setTimeout(() => {
