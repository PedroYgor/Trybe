...
Este repositório contém todas as atividades de aprendizagem desenvolvidas por _[Pedro Ygor Lopes](https://www.linkedin.com/in/pedro-ygor)_ enquanto estuda na [Trybe](https://www.betrybe.com/) :rocket:
...
- [x] 7-2: _JavaScript ES6 - Fluo de exceção e Objetos_
...
- [x] 15-5: _Testes em React-Redux

### Bloco 16: Projeto Jogo de Trivia

### Bloco 17: Context API e React Hooks

- [x] 18-1: Context API do React_
- [x] 18-2: React Hooks - useState e useContent
- [x] 18-3: React Hooks - useEffect e Hooks customizados_
...
- [x] 21-4: _Aula ao vivo + Projeto - One For All_
...
- [x] 22-6: _Atividades + Projeto - Talker Manager_

### Bloco 23: Introdução - NoSQL

- [x] 23-1: _Introdução - Arquitetura de Software_
- [x] 23-2: _Arquitetura de Software - Camada de Model_
- [x] 23-3: _Arquitetura de Software - Camada de Controller e Service_
- [x] 23-4: _Arquitetura Web - Rest e Restful_
- [x] 23-5: _Arquitetura de Software - Testando as Camadas_
...
- [x] 29-3: _Updates Simples_
- [x] 29-3: _Updates Complexos - Arrays_
